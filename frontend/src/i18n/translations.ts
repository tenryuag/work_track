export const translations = {
  ja: {
    ...
    cannotDeleteCustomerInUse: 'この顧客は注文で使用されているため削除できません。まず関連する注文を削除してください。',
    name: '名前',
    company: '会社名',
    phone: '電話番号',
    address: '住所',
    ...
    cannotDeleteMaterialInUse: 'この材料は注文で使用されているため削除できません。まず関連する注文を削除してください。',
    unit: '単位',
    ...
    noUsers: 'ユーザーがいません',
    cannotDeleteUserInUse: 'このユーザーは注文で使用されているため削除できません。まず関連する注文を削除してください。',
    role: '役割',
    status: 'ステータス',
    active: 'アクティブ',
    inactive: '非アクティブ',
  ...
  en: {
    ...
    cannotDeleteCustomerInUse: 'Cannot delete this customer because it is being used in orders. Please delete related orders first.',
    name: 'Name',
    company: 'Company',
    phone: 'Phone',
    address: 'Address',
    ...
    cannotDeleteMaterialInUse: 'Cannot delete this material because it is being used in orders. Please delete related orders first.',
    unit: 'Unit',
    ...
    cannotDeleteUserInUse: 'Cannot delete this user because they are assigned to orders. Please reassign or delete related orders first.',
    role: 'Role',
    status: 'Status',
    active: 'Active',
    inactive: 'Inactive',
    ...
    specificRoleApplication: 'Specific Role Application',
    controlMeasure: 'Control Measure',
    frequency: 'Frequency',
    valueType: 'Value Type',
    targetType: 'Target Type',
    targetValue1: 'Target Value 1',
    targetValue2: 'Target Value 2',
    aggregationMethod: 'Aggregation Method',
    evidenceRequired: 'Evidence Required',
    assignments: 'Assignments',
    evaluations: 'Evaluations',
    workPlans: 'Work Plans',
    globalWorkPlan: 'Global Work Plan',
    userWorkPlan: 'My Work Plan',
    score: 'Score',
    period: 'Period',
    submit: 'Submit',
    approve: 'Approve',
    ...
    fetchKpisFailed: 'Failed to fetch KPIs',
